...
const rows = [
  { name: 'Primary queue', status: <SovaBadge dot pulse tone="good">Ready</SovaBadge>, source: 'api', score: '91' },
  { name: 'Needs review', status: <SovaBadge dot tone="warn">Watch</SovaBadge>, source: 'manual', score: '68' },
  { name: 'Blocked source', status: <SovaBadge dot tone="bad">Blocked</SovaBadge>, source: 'sync', score: '12' },
]
...
function App() {
  return (
    <SovaProvider theme="jobs">
      ...
      >
        <SovaTopbar eyebrow="operator dashboard" title="Command center" actions={<><SovaBadge dot pulse tone="good">Live</SovaBadge><SovaButton variant="primary">Sync</SovaButton></>} />
